/**
 * translations.js - Internationalization for eSIM Myanmar
 * Supports English (en) and Myanmar (mm)
 */
...
const translations = {
  en: {
    ...
    network5G: '5G Network Support',
    network5GDesc: 'Experience blazing-fast 5G speeds across Myanmar and ASEAN region.',
    volte: 'VoLTE Enabled',
    volteDesc: 'Crystal-clear voice calls over LTE network with HD quality.',
    roaming: 'Advanced Roaming',
    roamingDesc: 'Stay connected worldwide with our advanced international roaming solutions.',
  ...
  mm: {
    ...
    volteDesc: 'LTE ကွန်ရက်ပေါ်တွင် HD အရည်အသွေးဖြင့် ကြည်လင်သော အသံခေါ်ဆိုမှုများ။',
    roaming: 'အဆင့်မြင့် ရိုမင်း',
    roamingDesc: 'ကျွန်ုပ်တို့၏ အဆင့်မြင့် နိုင်ငံတကာ ရိုမင်း ဖြေရှင်းချက်များဖြင့် ကမ္ဘာတစ်ဝှမ်း ချိတ်ဆက်နေပါ။',
    multiDevice: 'စက်ပစ္စည်းများစွာ ပံ့ပိုးမှု',
    ...
    validatePhone: 'ဖုန်းနံပါတ် အတည်ပြုရန်',
    deviceInfo: 'စက်ပစ္စည်း အချက်အလက်',
    deviceType: 'စက်ပစ္စည်း အမျိုးအစား',
